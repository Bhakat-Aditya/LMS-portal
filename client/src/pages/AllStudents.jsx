    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4 transition-colors duration-300">
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl shadow-xl p-8 max-w-sm text-center">
          ...
          <h2 className="font-extrabold text-gray-900 dark:text-gray-100 text-lg transition-colors">Authorizing Directory...</h2>
          <p className="text-gray-500 dark:text-gray-400 text-sm mt-1 transition-colors">Please wait while we verify your academic access.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold text-gray-400 dark:text-gray-500 mb-2">
            <Link to="/teacher/dashboard" className="hover:text-blue-600 transition-colors">Teacher Dashboard</Link>
            <span>&gt;</span>
            <span className="text-gray-900 dark:text-gray-100 font-bold transition-colors">Students Directory</span>
          </div>
          <h1 className="text-3xl font-black text-gray-900 dark:text-gray-100 tracking-tight transition-colors">All Registered Students</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1 font-medium transition-colors">
            Monitor student course enrollments and inspect detailed chapter quiz scores.
          </p>
        </div>
        <Link 
      ...
      {loading ? (
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-16 text-center shadow-sm flex flex-col items-center justify-center gap-4 transition-all duration-300">
          ...
          <p className="text-gray-500 dark:text-gray-400 text-sm font-semibold">Loading students directory...</p>
        </div>
      ) : error ? (
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-16 text-center shadow-sm transition-all duration-300">
          ...
          <p className="text-gray-500 dark:text-gray-300 text-sm font-bold">No students registered yet</p>
          <p className="text-gray-400 dark:text-gray-555 text-xs mt-1">Students will appear here as soon as they sign up on the portal.</p>
        </div>
      ) : (
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:hidden">
            {students.map((student) => {
              ...
              const registrationDate = new Date(student.createdAt).toLocaleDateString("en-IN", {
                day: "numeric",
                month: "short",
                year: "numeric"
              });
                  ...
                  <div className="p-5 flex flex-col gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="min-w-0">
                        <h3 className="font-extrabold text-gray-900 dark:text-gray-100 truncate text-sm transition-colors">{student.name}</h3>
                    ...
                    <div className="grid grid-cols-2 gap-2 border-t border-b border-gray-100 dark:border-gray-800 py-3 text-xs">
                      <div>
                        <p className="text-gray-400 dark:text-gray-500 font-semibold mb-0.5 uppercase tracking-wider text-[10px]">Registered On</p>
                        <p className="font-bold text-gray-700 dark:text-gray-300 flex items-center gap-1 transition-colors">
                          📅 {registrationDate}
                        </p>
                      </div>
                      <div>
                        <p className="text-gray-400 dark:text-gray-500 font-semibold mb-0.5 uppercase tracking-wider text-[10px]">Purchases</p>
                    ...
                    <div className="flex items-center justify-between mt-1">
                      <div className="text-xs">
                        {quizCount === 0 ? (
                          <span className="text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-800 border border-gray-150 dark:border-gray-700 px-2 py-1 rounded-full font-bold">No Attempts</span>
                        ) : (
                      ...
                      {quizCount === 0 ? (
                        ...
                        <div className="flex flex-col gap-2">
                          {student.quizResults.map((q) => {
                            ...
                            return (
                              <div key={q._id} className="bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-xl p-3 flex flex-col gap-2 transition-colors">
                                <div className="flex justify-between items-start">
                                  <div className="min-w-0">
                                    <p className="font-bold text-gray-850 dark:text-gray-150 text-xs truncate">{q.courseTitle}</p>
                                  ...
                                  <span className={`text-[9px] font-black uppercase px-1.5 py-0.5 rounded ${
                                    passed ? "bg-green-100 text-green-800 dark:bg-green-950/70 dark:text-green-400" : "bg-red-100 text-red-800 dark:bg-red-955/70 dark:text-red-400"
                                  }`}>
                                    {passed ? "Pass" : "Fail"}
                                  </span>
                                </div>
                                <div className="flex items-center gap-3 mt-1 text-xs">
                                  <div className="font-mono font-bold text-gray-700 dark:text-gray-300">{q.score}/{q.totalQuestions}</div>
                                  ...
                                  <span className={`font-mono font-extrabold ${passed ? "text-green-600 dark:text-green-400" : "text-red-500 dark:text-red-400"}`}>
                                    {q.percentage}%
                                  </span>
                                </div>
                              </div>
                  ...
                  {students.map((student) => {
                    ...
                    return (
                      <Fragment key={student._id}>
                        {/* Base Info Row */}
                        <tr className={`hover:bg-gray-50/50 dark:hover:bg-gray-950/30 transition-colors ${isExpanded ? "bg-blue-50/10 dark:bg-blue-950/10" : ""}`}>
                          <td className="px-6 py-5">
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                <p className="font-extrabold text-gray-900 dark:text-gray-100 transition-colors">{student.name}</p>
                                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium">{student.email}</p>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="px-6 py-5">
                            {coursesCount === 0 ? (
                              <span className="text-xs text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-800 border border-gray-150 dark:border-gray-700 px-2 py-0.5 rounded-full font-bold">None</span>
                            ) : (
                          ...
                          <td className="px-6 py-5">
                            {quizCount === 0 ? (
                              <span className="text-xs text-gray-400 dark:text-gray-555 bg-gray-50 dark:bg-gray-800 border border-gray-150 dark:border-gray-700 px-2 py-0.5 rounded-full font-bold">No Attempts</span>
                            ) : (
                        ...
                        {isExpanded && (
                          <tr>
                            <td colSpan="5" className="bg-gray-50/50 dark:bg-gray-950/50 border-t border-b border-gray-200 dark:border-gray-800 p-6 transition-colors">
                              <h3 className="font-extrabold text-gray-800 dark:text-gray-200 text-sm mb-4 flex items-center gap-1.5">
                                <span>📊</span> Quiz Grade Sheet for {student.name}
                              </h3>
                              ...
                              {quizCount === 0 ? (
                                <div className="text-center py-6 border border-dashed border-gray-200 dark:border-gray-800 rounded-lg bg-white dark:bg-gray-900">
                                  <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">This student has not submitted any quizzes yet.</p>
                                </div>
                              ) : (
                                  ...
                                  <table className="w-full text-left">
                                    ...
                                    <tbody className="divide-y divide-gray-100 dark:divide-gray-800 text-xs">
                                      {student.quizResults.map((q) => {
                                        const passed = q.percentage >= 60;
                                        return (
                                          <tr key={q._id} className="hover:bg-gray-55 dark:hover:bg-gray-950/50 transition-colors">
                                            ...
                                            <td className="px-4 py-3.5 font-mono font-bold">
                                              <span className={passed ? "text-green-600 dark:text-green-400" : "text-red-500 dark:text-red-400"}>
                                                {q.percentage}%
                                              </span>
                                            </td>
                                            <td className="px-4 py-3.5 w-1/3">
                                              <div className="flex items-center gap-2">
                                                ...
                                                <span className={`text-[9px] font-black uppercase px-1.5 py-0.5 rounded ${
                                                  passed ? "bg-green-100 text-green-800 dark:bg-green-950/60 dark:text-green-400" : "bg-red-100 text-red-800 dark:bg-red-955/60 dark:text-red-400"
                                                }`}>
                                                  {passed ? "Pass" : "Fail"}
                                                </span>
                                              </div>
